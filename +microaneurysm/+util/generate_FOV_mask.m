        % Generat the FOV binary image of the mask
        function mask = generate_FOV_mask( img)
            ...
            largemask = ~bwareaopen(~largemask, round(l * c / 40));
%             bwareaclose(largemask, round(l * c / 40));
